...
export default function TeaCatalog() {
  ...
  return (
    <section id="teas" className="py-20 bg-gray-50 relative overflow-hidden">
      ...
      <div className='absolute top-5 left-1/3 w-64 h-64 pointer-events-none opacity-20'>
        <Image 
          ...
          style={{filter: 'brightness(0) saturate(100%) invert(22%) sepia(85%) saturate(1300%) hue-rotate(82deg) brightness(88%) contrast(90%)'}}
        />
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div 
          ...
          className={`grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 scroll-animate-scale ${gridAnimation.isVisible ? 'visible' : ''}`}
        >
          {teas.map((tea, index) => (
            <div 
              key={tea.id} 
            ...
            >
              ...
              <div className="p-6">
                <div className="flex justify-between items-start mb-2">
                  ...
                  <span className="text-lg font-semibold text-green-800">{tea.price}</span>
                </div>
